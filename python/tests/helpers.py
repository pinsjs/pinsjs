...
class BoardDefaultSuite:
  ...
  def can_pin_file(self):
    ...
    assert self.read_lines(cached_path) == ["hello world"]
...
class BoardVersionsSuite:
  ...
  def can_pin_version(self):
    ...
    assert versions.version.length == 2
